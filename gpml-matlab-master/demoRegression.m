...
disp(' ')
disp('nlmle = gp(hyp2, @infGaussLik, meanfunc, covfunc, likfunc, x, y)')
hype = minimize(hyp, @gp, -100, @infGaussLik, meanfunc, covfunc, likfunc, x, y);
nlmle = gp(hype, @infGaussLik, meanfunc, covfunc, likfunc, x, y)
disp(' ')


disp('z = linspace(-1.9, 1.9, 101)'';')
z = linspace(-1.9, 1.9, 101)';
disp('[m s2] = gp(hype, @infGaussLik, meanfunc, covfunc, likfunc, x, y, z);')
[m s2] = gp(hype, @infGaussLik, meanfunc, covfunc, likfunc, x, y, z);
